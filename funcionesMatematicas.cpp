/*********************************************
* Programa: funcionesMatematicas.cpp
* Descripción:
*  Este programa verifica las funciones
matemáticas de la biblioteca de C.
***********************************************/
#include <stdio.h>
#include <math.h>
...
/* Inicio del main */
int main () {
    /* Calcula y despliega la raíz cuadrada */
    printf ("sqrt (%.1f) = %.1f\n", 900.0, sqrt (900.0));
    printf ("sqrt (%.1f) = %.1f\n", 9.0, sqrt (9.0));
    ...
    /* Calcula y despliega la función logaritmo (base e) */
    ...
    return 0;  /* Indica que el programa ha terminado con éxito*/
}  /* Fin del main */