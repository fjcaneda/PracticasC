/***********************************************************
* Programa: craps.c
* Descripciòn: Este programa emula el juego de dados
* llamado "craps"
...
int main () {
    ...
    return 0; /* Indica que el programa termina con éxito */
...
int tiraDados (void) {
    ...
    printf ( "El jugador ha obtenido una puntuación de %d + %d = %d\n", dado1, dado2, sumaTemp);
    return sumaTemp;
